...
func GenerateFuns() []Function {
	strs := []string{"print", "len", "read", "write", "quit", "type", "convert", "list", "array", "pair", "append", "system", "id", "ternary", "rand", "input", "glob", "env", "range", "fmt", "chdir", "split", "join", "cp", "mv", "rm", "pop", "itc", "cti", "has", "index", "replace", "re_match", "re_find", "rget", "rpost", "arrm", "value"}
	fs := []Function{}
